...
An active Blessed Script may authorize authentication only through an explicit
...
blocks inherited automatic authority. The ancestry and Blessing are rechecked
before signing; a missing or changed link cannot borrow the script's authority.
