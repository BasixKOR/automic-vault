...
final class PostHogTelemetry {
    ...
    func captureMainWindowOpened() {
        ...
        DispatchQueue.global(qos: .utility).async { [self] in
            captureMainWindowOpened(apiKey: apiKey)
        }
    }

    private func captureMainWindowOpened(apiKey: String) {
        let payload: [String: Any] = [
            "api_key": apiKey,
            "event": "automic_vault_main_window_opened",
